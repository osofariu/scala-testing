...
***** [[../src/test/scala/testingscala/report/ReportOnSpec.scala][ReportOnSpec]]
...
**** Pending tests
***** [[../src/test/scala/testingscala/certaintests/OmitSpec.scala][OmitSpec]
...
- one example of using traits to implement fixtures
- another one using an anonymous object
- also demonstrating mixing in the BeforeAndAfter trait
...
*** Other Notes
- org.scalatest.matchers.ShouldMatchers -- deprecated: use org.scalatest.Matchers
-
